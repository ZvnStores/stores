...
wget -O trialvmess "${REPO}xray/trialvmess.sh" && chmod +x trialvmess
wget -O renewws "${REPO}xray/renewws.sh" && chmod +x renewws
wget -O del-ws "${REPO}xray/delws.sh" && chmod +x del-ws
wget -O cek-ws "${REPO}xray/cek-ws.sh" && chmod +x cek-ws
sleep 0.5
# vless
echo -e "${Green}[ INFO ]${NC} ${Green}Downloading Main Vless${NC}"
wget -O add-vless "${REPO}xray/add-vless.sh" && chmod +x add-vless
wget -O trialvless "${REPO}xray/trialvless.sh" && chmod +x trialvless
wget -O renew-vless "${REPO}xray/renew-vless.sh" && chmod +x renew-vless
wget -O del-vless "${REPO}xray/del-vless.sh" && chmod +x del-vless
wget -O cek-vless "${REPO}xray/cek-vless.sh" && chmod +x cek-vless
sleep 0.5
# trojan
echo -e "${Green}[ INFO ]${NC} ${Green}Downloading Main Trojan${NC}"
wget -O add-tr "${REPO}xray/add-tr.sh" && chmod +x add-tr
wget -O trialtrojan "${REPO}xray/trialtrojan.sh" && chmod +x trialtrojan
wget -O del-tr "${REPO}xray/del-tr.sh" && chmod +x del-tr
wget -O renew-tr "${REPO}xray/renew-tr.sh" && chmod +x renew-tr
wget -O cek-tr "${REPO}xray/cek-tr.sh" && chmod +x cek-tr
sleep 0.5
# shadowsocks
echo -e "${Green}[ INFO ]${NC} ${Green}Downloading Main shadowsoks${NC}"
wget -O add-ssws "${REPO}xray/add-ssws.sh" && chmod +x add-ssws
wget -O trialssws "${REPO}xray/trialssws.sh" && chmod +x trialssws
wget -O del-ssws "${REPO}xray/del-ssws.sh" && chmod +x del-ssws
wget -O renew-ssws "${REPO}xray/renew-ssws.sh" && chmod +x renew-ssws
...
sleep 0.5
wget -O anuku "${REPO}xray/anuku.sh" && chmod +x anuku
wget -O jilmek "${REPO}xray/jilmek.sh" && chmod +x jilmek
wget -O bdsm "${REPO}xray/bdsm.sh" && chmod +x bdsm
wget -O limiter "${REPO}xray/limiter.sh" && chmod +x limiter
sleep 0.5
